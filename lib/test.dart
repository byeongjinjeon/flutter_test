...
class Test extends StatelessWidget {
  const Test({super.key, required String title});

  @override
  Widget build(BuildContext context) {
    return Scaffold(appBar: BaseAppBar(), body: const PlutoMenuBarDemo());
  }
}

class PlutoMenuBarDemo extends StatefulWidget {
  const PlutoMenuBarDemo({super.key});
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          const SizedBox(height: 30),
          PlutoMenuBar(mode: PlutoMenuBarMode.hover, menus: whiteHoverMenus),
          const SizedBox(height: 30),
          PlutoMenuBar(
          ...
          const SizedBox(height: 30),
          PlutoMenuBar(mode: PlutoMenuBarMode.tap, menus: whiteTapMenus),
          const SizedBox(height: 30),
          PlutoMenuBar(
            backgroundColor: Colors.deepOrange,
            itemStyle: const PlutoMenuItemStyle(
          ...
          PlutoMenuBar(
            ...
            itemStyle: const PlutoMenuItemStyle(enableSelectedTopMenu: true),
            menus: [
              PlutoMenuItem(
                title: 'Select1',
                id: 'Select1',
          ...
          PlutoMenuBar(
            ...
            menus: [
              PlutoMenuItem(title: 'Toggle1', id: 'Toggle1'),
              PlutoMenuItem(title: 'Toggle2', id: 'Toggle2'),
              PlutoMenuItem(title: 'Toggle3', id: 'Toggle3'),
              PlutoMenuItem(title: 'Toggle4', id: 'Toggle4'),
              PlutoMenuItem(title: 'Toggle5', id: 'Toggle5'),
            ],
          ),
...
enum _RadioItems { one, two, three }
